...
#define USE_EXTMEM_BUFFER		1		// set this to 1 to use PSRAM for the tft buffer
...
#define USE_STARTUP_IMAGE		0		// display a startup image
...
#define ENABLE_EXTRAM_CACHE		1		// enable PSRAM cache. Is experimental.
